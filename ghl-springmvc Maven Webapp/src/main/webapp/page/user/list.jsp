...
<script type="text/javascript" src="js/common/extend-easyui-validatebox.js" ></script>
...
<script type="text/javascript">
	...
	window.onresize = function() {
		//在窗口变化大小时重新获取窗口大小,必须有个延时等窗口大小稳定后再获取准确的新的窗口大小,超时太多页面调整迟钝,超时太小则获取不到新的页面大小值
	...
	<div id="body" region="center">
		...
		<div id="search_area">
			<table>
				<tr>
					<td>用户ID：</td>
					<td><input name="userId" id="queryUserId" /></td>
					<td>用户名：</td>
					<td><input name="userName" id="queryUserName" /></td>
					<td>性别：</td>
					<td>
						<select name="sex" id="querySex" >
		...
		<!-- 数据表格区域 -->
		<div>
			<table id="userGrid" cssstyle="table-layout: fixed;" >
			</table>
		</div>
		<!-- 表格顶部工具按钮 -->
		<div id="toolbar">
		...
		<!-- 对话框 -->
		<div id="saveOrUpdateDialog" closed="true"
